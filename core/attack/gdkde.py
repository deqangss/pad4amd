...
class GDKDE(BaseAttack):
    ...
    def __init__(self, ben_hidden=None, bandwidth=20., kappa=1., manipulation_x=None, omega=None, device=None):
        super(GDKDE, self).__init__(kappa, manipulation_x, omega, device)
