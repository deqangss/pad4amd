...
indicator_argparse.add_argument('--n_pertb', type=int, default=10, help='number of perturbations.')
...
def _main():
    ...
    model = model.to(dv)
    attack = OMPA(lambda_=args.lambda_, n_perturbations=args.n_pertb, device=model.device, use_indicator=True)
