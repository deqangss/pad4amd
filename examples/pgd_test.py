...
atta_argparse.add_argument('--norm', type=str, default='linf', choices=['l2', 'linf'], help="gradient normalization, either of 'l2' and 'linf'.")
atta_argparse.add_argument('--n_step', type=int, default=10, help='maximum number of steps.')
atta_argparse.add_argument('--step_length', type=float, default=0.1, help='step length in each step.')
