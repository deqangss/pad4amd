...
from core.defense import AdvMalwareDetectorClsPlus
...
dla_argparse.add_argument('--m', type=int, default=20,
...
def _main():
    ...
    cls_plus_model = AdvMalwareDetectorClsPlus(md_nn_model=None,
    ...
    if args.mode == 'train':
        cls_plus_model.fit(train_dataset_producer,
