...
atta_argparse.add_argument('--n_step', type=int, default=200,
                           help='maximum number of steps.')
atta_argparse.add_argument('--lr', type=float, default=0.1,
                           help='learning rate.')
atta_argparse.add_argument('--step_check', type=int, default=200,
...
def _main():
    ...
    for x, y in mal_test_dataset_producer:
        ...
        # x = x.uniform_(0., args.lr).clamp_(min=0, max=1)
