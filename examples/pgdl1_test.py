...
atta_argparse.add_argument('--kde', action='store_true', default=False, help='attack model with kernel density estimation.')
...
def _main():
    ...
    attack = PGDl1(device=model.device,
                   kappa=args.kappa
                   )
